...
export default function MeetingsPage() {
  ...
  function startEdit(meeting: MeetingRecord) {
    ...
    setForm({
      ...
      personalQrEnabled: meeting.personalQrEnabled ?? true,
      personalQrDeliveryMethods:
        meeting.personalQrDeliveryMethods ?? "download,email,telegram",
      ...
      <label className="flex items-start gap-3 text-sm font-semibold">
        ...
        <span>
          ...
          <span className="mt-1 block text-xs font-normal leading-5 text-muted-fg">
            Admin can choose how participants receive their personal QR after
            public registration.
          </span>
        </span>
      </label>
